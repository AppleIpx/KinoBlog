...
MIGRATION_MODULES = {"sites": "some_proj.contrib.sites.migrations"}
...
STATIC_ROOT = str(BASE_DIR / "app/staticfiles")
# https://docs.djangoproject.com/en/dev/ref/settings/#static-url
STATIC_URL = "/static/"
# https://docs.djangoproject.com/en/dev/ref/contrib/staticfiles/#std:setting-STATICFILES_DIRS
STATICFILES_DIRS = [str(APPS_DIR / "app/static")]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "some_proj.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ACCOUNT_FORMS = {"signup": "some_proj.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "some_proj.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "some_proj.users.forms.UserSocialSignupForm"}
